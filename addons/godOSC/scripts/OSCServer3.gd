...
var server_p3 = UDPServer.new()
var peers: Array[PacketPeerUDP] = []

func _ready():
	server_p3.listen(port_p3)
...
func _process(_delta):
	server_p3.poll()
	if server_p3.is_connection_available():
		var peer: PacketPeerUDP = server_p3.take_connection()
...
func parse_message(packet: PackedByteArray):
	...
	print("P3: OSC Server Empfangene Nachricht:", address, vals)  # Debug-Ausgabe
